...
SET "PLUGIN_DIR=C:\Users\Nathan\Git\Tag-Manager-for-SureCart\rup-crm-tag-mapper"
IF "%PLUGIN_DIR:~-1%"=="\" SET "PLUGIN_DIR=%PLUGIN_DIR:~0,-1%"
SET "PLUGIN_FILE=%PLUGIN_DIR%\rup-crm-tag-mapper.php"
SET "CHANGELOG_FILE=C:\Users\Nathan\Git\rup-changelogs\rup-crm-tag-mapper.txt"
